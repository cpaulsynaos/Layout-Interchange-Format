...
| *minimumLeft* | meter | float64 | Minimum corridor margin required to the left of the edge.<br><br>Note: Definining no value is equivalent to defining zero. |
| *mininumRight* | meter | float64 | Minimum corridor margin required to the right of the edge.<br><br>Note: Definining no value is equivalent to defining zero. |
| } |  |  |  |
